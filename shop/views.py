...
class ProfileView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            zipcode = form.cleaned_data['zipcode'] # change
...
def add_to_cart(request):
    ...
    user = request.user  # This is Login User
...
def show_cart(request):
    ...
    for p in cart:
        ...
        amount += value
    totalamount = amount + 40  # 40 is shipping charge
...
def plus_cart(request):
    if request.method == 'GET':
        ...
        # print(prod_id)
        # Q is for multiple filter Condition
        ...
        amount = 0
        for p in cart:
            value = p.quantity * p.product.selling_price  # changed discount to selling
            amount = amount + value
        ...
        return JsonResponse(data)  # only dictionary can be passed
